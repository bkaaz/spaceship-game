...
export class PlayerBehavior implements GameEntityBehavior {
    ...
    draw(entity: GameEntity, canvasCtx: CanvasRenderingContext2D, gameCtx: GameContext): void {
        ...
        canvasCtx.drawImage(this.image, -this.image.width / 2, -this.image.height / 2);
